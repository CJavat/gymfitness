...
?>
  ...
  ?>
    ...
    <p>
      ...
      <input class="widefat" type="number" name="<?php echo esc_attr($this->get_field_name('cantidad')) ?>" id="<?php echo esc_attr($this->get_field_id('cantidad')) ?>" value="<?php echo esc_attr($cantidad) ?>" />
    </p>
